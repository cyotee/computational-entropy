...
**Status:** **FINAL program report v1.0 (2026-07-15)** — claim-freeze cycle closed · preliminary research  
**Canonical final draft of this program cycle.** (Content twin: `DRAFT.md`.)  
...
**How to read:** Full program report with front **Results** and final **§8 Conclusions**. Core formulas link to canonical repo files; discrete ledgers and dual toys are witnesses under stated rigor labels. **Nothing here has GR-level certainty.** **Read order:** Results → §§1–7 → §8 Final conclusions → Bibliography. **New research cycle:** OPEN_AVENUES.md.
...
**Full roadmap:** [`synthesis/OPEN_AVENUES.md`](../../synthesis/OPEN_AVENUES.md) — what **“needs new theory”** means (missing theorems/constructions, **not** “wrong program”); missing theorem statements for each O-item; experiment bucket (only after sharp predictions); suggested next-cycle priority (default **O1**).
...
| Post-freeze avenues (new theory vs experiment) | `synthesis/OPEN_AVENUES.md` |
