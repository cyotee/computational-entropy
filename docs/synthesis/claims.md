...
| C18 | **R4a promotion = candidate hypothesis:** promoting entropy production into the field equations is Bianchi-consistent, reduces to \(\Lambda\)CDM as coupling \(\xi\to0\), and departs as **phantom interacting dark energy** \(w_0=-1-0.143\xi\) (Landauer-fixed sign), already bounded \(\xi<0.35\). A departure exists **as a testable model**; magnitude/coupling **open** | **derived model** (candidate; coupling unfixed) | [../emergent-gravity/r4a-promotion.md](../emergent-gravity/r4a-promotion.md) |
